...
craftingTable.removeRecipe(<item:thermal:spinach_block>);
craftingTable.removeRecipe(<item:thermal:eggplant_block>);
craftingTable.removeRecipe(<item:thermal:corn_block>);
craftingTable.removeRecipe(<item:thermal:peanut_block>);
...
[<item:thermal:sawdust>, <item:thermal:sawdust>, <item:thermal:sawdust>],
[<item:thermal:sawdust>, <item:thermal:sawdust>, <item:thermal:sawdust>]]);
craftingTable.addShaped("peanut_block", <item:thermal:peanut_block>,
[[<item:simplefarming:peanut>, <item:simplefarming:peanut>, <item:simplefarming:peanut>],
[<item:simplefarming:peanut>, <item:simplefarming:peanut>, <item:simplefarming:peanut>],
[<item:simplefarming:peanut>, <item:simplefarming:peanut>, <item:simplefarming:peanut>]]);
craftingTable.addShaped("spinach_block", <item:thermal:spinach_block>,
[[<item:simplefarming:spinach>, <item:simplefarming:spinach>, <item:simplefarming:spinach>],
[<item:simplefarming:spinach>, <item:simplefarming:spinach>, <item:simplefarming:spinach>],
[<item:simplefarming:spinach>, <item:simplefarming:spinach>, <item:simplefarming:spinach>]]);
craftingTable.addShaped("corn_block", <item:thermal:corn_block>,
[[<item:simplefarming:corn>, <item:simplefarming:corn>, <item:simplefarming:corn>],
[<item:simplefarming:corn>, <item:simplefarming:corn>, <item:simplefarming:corn>],
[<item:simplefarming:corn>, <item:simplefarming:corn>, <item:simplefarming:corn>]]);
craftingTable.addShaped("eggplant_block", <item:thermal:eggplant_block>,
[[<item:simplefarming:eggplant>, <item:simplefarming:eggplant>, <item:simplefarming:eggplant>],
[<item:simplefarming:eggplant>, <item:simplefarming:eggplant>, <item:simplefarming:eggplant>],
[<item:simplefarming:eggplant>, <item:simplefarming:eggplant>, <item:simplefarming:eggplant>]]);
craftingTable.addShaped("strawberry_block", <item:thermal:strawberry_block>,
[[<item:simplefarming:strawberries>, <item:simplefarming:strawberries>, <item:simplefarming:strawberries>],
[<item:simplefarming:strawberries>, <item:simplefarming:strawberries>, <item:simplefarming:strawberries>],
[<item:simplefarming:strawberries>, <item:simplefarming:strawberries>, <item:simplefarming:strawberries>]]);
craftingTable.addShaped("radish_block", <item:thermal:radish_block>,
[[<item:simplefarming:radish>, <item:simplefarming:radish>, <item:simplefarming:radish>],
[<item:simplefarming:radish>, <item:simplefarming:radish>, <item:simplefarming:radish>],
[<item:simplefarming:radish>, <item:simplefarming:radish>, <item:simplefarming:radish>]]);
...
[<item:thermal:lead_ingot>, <item:thermal:rf_coil>, <item:thermal:lead_ingot>],
[<item:minecraft:redstone>, <item:thermal:sulfur_dust>, <item:minecraft:redstone>]]);
...
craftingTable.removeRecipe(<item:thermal:spinach>);
craftingTable.removeRecipe(<item:thermal:spinach_seeds>);
craftingTable.removeRecipe(<item:thermal:tea>);
craftingTable.removeRecipe(<item:thermal:tea_seeds>);
craftingTable.removeRecipe(<item:thermal:tea_block>);
craftingTable.removeRecipe(<item:thermal:bell_pepper>);
craftingTable.removeRecipe(<item:thermal:bell_pepper_block>);
craftingTable.removeRecipe(<item:thermal:rice>);
craftingTable.removeRecipe(<item:thermal:rice_block>);
craftingTable.removeRecipe(<item:thermal:peanut>);
craftingTable.removeRecipe(<item:thermal:radish>);
craftingTable.removeRecipe(<item:thermal:eggplant>);
craftingTable.removeRecipe(<item:thermal:corn>);
craftingTable.removeRecipe(<item:thermal:onion>);
craftingTable.removeRecipe(<item:thermal:onion_block>);
craftingTable.removeRecipe(<item:thermal:barley>);
craftingTable.removeRecipe(<item:thermal:barley_block>);
...
craftingTable.removeRecipe(<item:thermal:tomato_block>);
craftingTable.removeRecipe(<item:thermal:tomato>);
craftingTable.removeRecipe(<item:thermal:tomato_seeds>);
...
craftingTable.removeRecipe(<item:thermal:strawberry_seeds>);
craftingTable.removeRecipe(<item:thermal:coffee>);
craftingTable.removeRecipe(<item:thermal:coffee_block>);
craftingTable.removeRecipe(<item:simplefarming:tomato_seeds>);
craftingTable.removeRecipe(<item:simplefarming:tomato>);
craftingTable.removeRecipe(<item:simplefarming:onion_seeds>);
craftingTable.removeRecipe(<item:simplefarming:onion>);
craftingTable.removeRecipe(<item:thermal:green_bean_block>);
craftingTable.removeRecipe(<item:thermal:green_bean>);
craftingTable.removeRecipe(<item:simplefarming:rice_hay_block>);
craftingTable.removeRecipe(<item:simplefarming:rice>);
...
craftingTable.addShapeless("egg_sandwich", <item:simplefarming:egg_sandwich>, 
[<tag:forge:grain>, <item:simplefarming:cooked_bacon>,
<item:farmersdelight:fried_egg>]);
craftingTable.removeRecipe(<item:simplefarming:fried_rice>);
craftingTable.addShapeless("fried_rice", <item:simplefarming:fried_rice>, 
[<item:farmersdelight:rice>, <item:farmersdelight:fried_egg>,
<tag:forge:vegetables>]);
<tag:forge:fruits/melon>.addItems(<item:thermal:frost_melon>);
<tag:forge:vegetables>.addItems(<item:thermal:frost_melon_slice>);
<tag:forge:crops>.addItems(<item:thermal:frost_melon_slice>);
<tag:forge:vegetables>.addItems(<item:thermal:sadiroot>);
<tag:forge:crops>.addItems(<item:thermal:sadiroot>);
craftingTable.removeRecipe(<item:thermal:chocolate_cake>);
craftingTable.addShaped("chocolate_cake", <item:thermal:chocolate_cake>,
[[<tag:forge:milk>, <item:simplefarming:strawberries>, <tag:forge:milk>],
[<item:minecraft:cocoa_beans>, <tag:forge:eggs>, <item:minecraft:cocoa_beans>],
[<tag:forge:grain>, <item:simplefarming:strawberries>, <tag:forge:grain>]]);
craftingTable.removeRecipe(<item:thermal:spice_cake>);
craftingTable.addShaped("spice_cake", <item:thermal:spice_cake>,
[[<tag:forge:milk>, <item:thermal:sadiroot>, <tag:forge:milk>],
[<item:minecraft:sugar>, <tag:forge:eggs>, <item:minecraft:sugar>],
[<tag:forge:grain>, <item:thermal:sadiroot>, <tag:forge:grain>]]);
...
craftingTable.addShaped("north_compass", <item:inspirations:north_compass>,
...
furnace.removeRecipe(<item:mekanism:ingot_copper>, <item:thermal:copper_ore>);
furnace.removeRecipe(<item:mekanism:ingot_tin>, <item:thermal:tin_ore>);
...
<recipetype:smoking>.removeRecipe(<item:simplefarming:cooked_egg>);
...
craftingTable.addShapeless("phytogro", <item:thermal:phytogro> * 4, 
[<item:thermal:sawdust>, <item:thermal:sawdust>,
<item:thermal:niter_dust>,<item:thermal:slag>]);
...
[<item:minecraft:string>, <item:thermal:rosin>, <item:minecraft:air>],
[<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:string>]]);
craftingTable.addShaped("processor_binding", <item:refinedstorage:processor_binding> * 4,
[[<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
[<item:minecraft:string>, <item:thermal:rosin>, <item:minecraft:string>],
[<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>]]);
